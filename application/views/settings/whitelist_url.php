      ...
      <div class="row">
        <div class="span8">
          ...
          <div class="alert">
            ...
            <span>
              <b>ERROR: </b>Incorrect password.</span>
          </div>
            <?php endif; ?>
        </div>
        <div class="span4">
          <div class="well"><p><b>You are accessing the secret Whitelist URL. Enter the password to add your ip address to allow list.</b></p>
            <form class="form-vertical" name="loginform" id="loginform" method="post" action="">
              <div class="control-group">
                <label class="control-label">Password</label>
                <div class="controls">
                  <input type="password" class="input-large" name="whitelist_passwd" id="pass"> 
                </div>
              </div>
