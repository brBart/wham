    ...
    <script type="text/javascript">
        $(document).ready(function() {
            $("#modify_acct_sbmt").bind("click", function(e) {
                ...
                if ($("#ip").val() == "0") {
                    alert("Please select a valid ip from the list");
                    return;
                }
                ...
                $.ajax({
                    ...
                    success: function(text) {
                        ...
                        $("#results_div p").html("<p align=right><a class='btn btn-success' href='<?=site_url() . "/servers/viewserver/whm_setsiteip/" . $s_id . "/" ?>'><span class='btn-label'>Go back</span></a><br/></p><b>RESULT:</b>");
                    }
                });    
            });
        });
        ...
        <div class="row-fluid">
          <div class="span12">
            <div>
                ...
                <p><b>Change Site's IP Address</b> / <a href="<?= site_url() ?>/servers/viewserver/whm_setsiteip_multi/<?= $s_id ?>/">Set IP Address For Multiple Accounts</a></p><hr/>
