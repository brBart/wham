<?php Template::printHeader_(); ?>
  ...
  <body>
      ...
      <?php Template::printSideBar_("add_new_dc"); ?>
    <div class="row-fluid">
      <div class="span12">
        <ul class="breadcrumb">
          <li>
          ...
          <li class="active">Add a new data center</li>
        </ul>
        <div class="row-fluid">
          <div class="span12">
            <div>
              <p><b>New Data Center Info</b><hr/></p>
              <form method='post' action="<?php echo site_url(); ?>/servers/adddc/newdc/">
                      ...
                      <tr>
                          ...
                          <td valign="top">
                              <button class="btn btn-success" href="#">
                                <span class="btn-label"><i class="icon-file icon-white"></i> Add new DC</span>
                              </button>
