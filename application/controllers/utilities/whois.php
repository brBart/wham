...
class Whois extends CI_Controller {
	...
	{ 
            ...
            $this->load->view('utilities/whois', $args);
        }
        ...
        public function backend($val="") {
            if ($val == "")
                ...
                $str = json_encode(array("inputText" => "whois:$val", "resultIndex" => 1));
                ...
                $arr = array(
                    ...
                    //"Cookie: ASP.NET_SessionId=jxzsdxnlnrfv3gbrmb3ub0es; ismobile=False; _vis_opt_s=1%7C; _vis_opt_exp_51_exclude=1; _vis_opt_test_cookie=1; MxVisitorUID=cae595ab-bebb-4b99-b431-8e9c3f34cb7a; __utma=74094414.2078131587.1368531155.1368531155.1368531155.1; __utmb=74094414.11.8.1368531226114; __utmc=74094414; __utmz=74094414.1368531155.1.1.utmcsr=(direct)|utmccn=(direct)|utmcmd=(none)"
                ...
                if ($tmp === FALSE){
                    echo "<div class='tool-result-div'>Error retrieving information from external source. 
