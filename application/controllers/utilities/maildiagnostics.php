...
class Maildiagnostics extends CI_Controller {
	...
	{ 
            ...
            $this->load->view('utilities/maildiagnostics', $args);
        }
        ...
        public function backend($val="") {
            if ($val == "")
                ...
                $str = json_encode(array("inputText" => "smtp:$val", "resultIndex" => 1));
                ...
                if ($tmp === FALSE){
                    ...
                    $final_html = preg_replace("/<a href=.archive.*?<\/a>/", "", $final_html);
