...
class Mxlookup extends CI_Controller {
	...
	{ 
            ...
            $this->load->view('utilities/mxlookup', $args);
        }
        
        public function backend($val="", $spf="") {
            if ($val == "")
                ...
                if ($spf == "spf")
                    $str = json_encode(array("inputText" => "spf:$val", "resultIndex" => 1));
                else
                    $str = json_encode(array("inputText" => "mx:$val", "resultIndex" => 1));
