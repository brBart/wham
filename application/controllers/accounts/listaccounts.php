...
class Listaccounts extends CI_Controller {
	...
	{ 
            ...
            if ($query->num_rows() > 0 && $query->num_rows() < 2000) {
                ...
                $this->load->view('accounts/listaccounts', $args); 
            }
            else if ($query->num_rows() > 2000) {
                header("Location: " . site_url() . "/accounts/listaccounts/page/");
            }
        ...
        public function page() {
            ...
            $config["base_url"] = site_url() . "/accounts/listaccounts/page/";
            ...
            $this->load->view("accounts/listaccounts_page", $args);
