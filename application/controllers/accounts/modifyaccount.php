...
class Modifyaccount extends CI_Controller {
	...
	{ 
            ...
            if ($query->num_rows() > 0 && $query->num_rows() < 2000) {
                ...
                $this->load->view('accounts/modifyaccount', $args);  
            } 
            else if ($query->num_rows() > 2000) {
                header("Location: " . site_url() . "/accounts/modifyaccount/page/");
            }
            else {
        ...
        public function page() {
            ...
            $config["base_url"] = site_url() . "/accounts/modifyaccount/page/";
            ...
            $this->load->view("accounts/modifyaccount_page", $args);
